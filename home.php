...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style.css">
        <style>
            ...
            .banner-overlay{position:absolute;inset:0;background:rgba(0,0,0,.35);z-index:1}
            .banner-section .container,.banner-section .home-banner{position:relative;z-index:2}
        </style>
</head>
<body>
<div class="main-wrapper">
    ...
    <section class="banner-section banner-slider">
        <!-- Background video -->
        <video class="banner-bg-video" autoplay muted loop playsinline preload="auto" poster="assets/img/car-right.png" aria-hidden="true">
