  ...
  <div class="main-wrapper">
    ...
    <div class="breadcrumb-bar">
      <div class="container"><div class="row align-items-center text-center"><div class="col-md-12 col-12">
        ...
        <nav aria-label="breadcrumb" class="page-breadcrumb"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="home.php">Home</a></li><li class="breadcrumb-item"><a href="listing-grid.php">Listings</a></li><li class="breadcrumb-item active" aria-current="page"><?= h($title) ?></li></ol></nav>
      </div></div></div>
    </div>
