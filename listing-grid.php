...
// helper: build query string preserving existing GET params, overriding with $overrides
                ...
                <span><img src="assets/img/icons/search.svg" alt="img"></span>
                        ...
                        <div class="fuel-list">
                          <ul>
							...
							<a href="listing-grid.php" class="btn reset-filter w-100 mt-2">Reset Filter</a>
            			</form>
				 	</div>
        <div class="col-lg-9">
          <div class="row">
              ...
              <div class="listing-item">
                ...
                <div class="listing-content">
                  <div class="listing-features d-flex align-items-end justify-content-between">
                    ...
                    <div class="list-km">
                      <span class="km-count">
                        <img src="assets/img/icons/map-pin.svg" alt="loc">3.2m
                      </span>
                    </div>
                  </div>
                  <div class="listing-details-group">
                    <ul>
                      <li>
                        <span>
                          <img src="assets/img/icons/car-parts-05.svg" alt="Transmission">
                        </span>
                        <p>
                          <?= h($c['transmission'] ?: 'Auto') ?>
                        </p>
                      </li>
                      <li>
                        <span>
                          <img src="assets/img/icons/car-parts-02.svg" alt="Odometer">
                        </span>
                        <p>
                          <?= h(($c['odometer'] !== null && $c['odometer'] !== '') ? $c['odometer'].' KM' : '—') ?>
                        </p>
                      </li>
                      <li>
                        <span>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <p>
                          <?= h(($c['passengers'] ?: $c['seats'] ?: 4)) ?> Persons
                        </p>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div class="listing-button">
                    <a href="listing-details.php?id=<?= (int)$c['id'] ?>" class="btn btn-order">
                      <span>
